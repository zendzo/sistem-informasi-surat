...
<div class="modal-content">
   ...
   <div class="modal-body">
      <form class="form-horizontal"  action="{{ route('admin.type-surat.update',$type->id) }}" method="POST">
         {{ csrf_field() }}
         {{ method_field('PATCH') }}
         ...
         <div class="form-group{{ $errors->has('kode') ? ' has-error' : '' }}">
            <label for="kode" class="col-sm-2 control-label">Type Surat</label>
            <div class="col-sm-10">
            <input id="kode" name="kode" type="text" class="form-control"  value="{{ $type->kode }}" required>
            @if ($errors->has('kode'))
                  <span class="help-block">
